describe('Arithmetic', function() {  
  ...
  describe('Power', function() {
    ...
    it('raises a positive integer to the power of zero', function(done) {
      request.get('/arithmetic?operation=pow&operand1=5&operand2=0')
          .expect(200)
          .end(function(err, res) {
    ...
    it('raises a negative integer to an even power', function(done) {
      request.get('/arithmetic?operation=pow&operand1=-3&operand2=2')
          .expect(200)
          .end(function(err, res) {
    ...
    it('raises zero to a positive power', function(done) {
      request.get('/arithmetic?operation=pow&operand1=0&operand2=5')
          .expect(200)
          .end(function(err, res) {
              expect(res.body).to.eql({ result: 0 });
              done();
    ...
    it('raises a floating point number to a power', function(done) {
      request.get('/arithmetic?operation=pow&operand1=0.5&operand2=2')
          .expect(200)
          .end(function(err, res) {
              expect(res.body).to.eql({ result: 0.25 });
              done();
